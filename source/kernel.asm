;H70 --- The H70 Operating System Kernel
;===================================================================

	BITS 16
	%DEFINE H70OS_VER '1.0.0'	 ;OS version number
	%DEFINE H70OS_API_VER 1	; API version for programs to check
	%DEFINE KEY_ESC		27
...
os_main:
	...
	mov es, ax			; segments ever again, as H70OS and its programs
...
option_screen:
	...
	os_version_msg2		db 'Version ', H70OS_VER, 0

	dialog_string_1		db 'Welcome to H70OS Operating System', 0
